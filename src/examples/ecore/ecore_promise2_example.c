...
_simple(void)
{
   efl_future2_then(_simple_future_get(EINA_FALSE, EINA_TRUE), _simple_ok,
                    NULL);
   efl_future2_then(_simple_future_get(EINA_TRUE, EINA_FALSE),
                    _simple_err, NULL);
}
...
_chain_no_errors(void)
{
   ...
   f = efl_future2_then(_simple_future_get(EINA_FALSE, EINA_FALSE),
                        _chain_no_errors_cb, NULL);
   f = efl_future2_then(f, _chain_no_errors_cb, NULL);
   f = efl_future2_then(f, _chain_no_errors_cb, NULL);
   efl_future2_then(f, _chain_no_errors_cb, NULL);
}
...
_chain_with_error(void)
{
   ...
   f = efl_future2_then(f, NULL, NULL);
   efl_future2_then(f, _simple_err, NULL);
}
...
_chain_inner_no_errors(void)
{
   ...
   f = efl_future2_then(_simple_future_get(EINA_FALSE, EINA_FALSE),
                        _chain_inner_cb, NULL);
   efl_future2_then(f, _chain_inner_last_cb, NULL);
}
...
_chain_inner_errors(void)
{
   ...
   f = efl_future2_then(_simple_future_get(EINA_FALSE, EINA_FALSE),
                        _chain_inner_cb, (void *)1);
   efl_future2_then(f, _err_inner_chain, NULL);
}
...
_future_cancel(void)
{
   ...
   f = efl_future2_then(_simple_future_get(EINA_FALSE, EINA_FALSE),
                        _canceled_cb, NULL);
   f = efl_future2_then(f, _canceled_cb, NULL);
   f = efl_future2_then(f, _canceled_cb, NULL);
   f = efl_future2_then(f, _canceled_cb, NULL);
   f = efl_future2_then(f, _canceled_cb, NULL);
